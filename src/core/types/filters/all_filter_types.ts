...
import { FilterTypeSlider } from '@pictaccio/admin-gui/core/types/filters/type_slider';
import { FilterTypeTag } from '@pictaccio/admin-gui/core/types/filters/type_tag';
