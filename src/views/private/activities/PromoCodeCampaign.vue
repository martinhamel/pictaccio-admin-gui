...
import CrudDialogCampaign
    from '@pictaccio/admin-gui/views/private/activities/companions/crud_dialogs/CrudDialogCampaign.vue';
import {
    CAMPAIGN_COLUMNS
} from '@pictaccio/admin-gui/views/private/activities/companions/data_table_columns/campaign_columns';
