...
<template>
    <div class="product-renderer digital-product">
        <multi-columns :noStretch="true">
            <template #column-1>
                ...
                <div class="product-image">
                    <img src="@/assets/digitals.webp" alt="Product Image">
                </div>
            </template>
            <template #column-2>
...
export default class DigitalProductRenderer extends Vue {
    @Prop
