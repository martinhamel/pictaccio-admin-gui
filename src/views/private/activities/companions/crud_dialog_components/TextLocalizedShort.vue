...
export default class TextLocalizedShort<Tmodel, Tvalue, ToptionId, ToptionValue>
    ...
    /* EVENT HANDLER */
    private async textLocalizedShortBlur(event): Promise<void> {
